package com.ecommerce.studentmarket.product.items.services;
...
import com.ecommerce.studentmarket.product.items.dtos.ProductDtoRespone;
...
import com.ecommerce.studentmarket.product.items.repositories.ProductRepository;
...
public class ProductService {
    ...
    public Page<ProductDtoRespone> getAllProduct(Long maGHDT, Integer page, Integer size) {
    ...
    public Page<ProductDtoRespone> searchProductByName(Long maGHSH,String tenSP, Integer page, Integer size) {
        Pageable pageable = PageRequest.of(page, size);
...
//        Xóa các ảnh liên quan
    ...
    public Page<ProductDtoRespone> getProductByStoreId(Long maGHSH, Integer page, Integer size){
        Pageable pageable = PageRequest.of(page, size);
...
//  Lấy sản phẩm theo người bán không bị ẩn
    public Page<ProductDtoRespone> getProductByStoreIdNotHidden(Long maGHSH, Integer page, Integer size){
        Pageable pageable = PageRequest.of(page, size);
    ...
    private ProductDomain convertToProductDomain(ProductDto productDto) {
        ...
        Optional.ofNullable(productDto.getMoTa()).ifPresent(data::setMoTa);
